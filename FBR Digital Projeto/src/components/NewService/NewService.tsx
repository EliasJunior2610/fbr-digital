        ...
        <div id="etiqueta">
          ...
          <div id="etiqueta-p">
            <p>
              ...
              Repudiandae quia fuga excepturi veritatis quas nobis ut, <br />
              quis sed placeat eius fugiat dolore at earum? <br /> Dolores
              debitis laboriosam <br />
              distinctio natus autem?
            </p>
          </div>
          <div id="etiqueta-h4">
            <h4>Assinar agora</h4>
      ...
      {isPopupVisible && (
        <div className="popup">
          <div className="popup-content">
            ...
            <Link to="/">
              <button onClick={closePopupAndRedirect}>Concluir</button>
            </Link>
          </div>
        </div>
      )}
