  ...
  const requestsData = [
    {
      ...
      data: "30/10/24",
      horario: "12:00-16:00",
      observacoes: "Instalar na sala principal.",
      corBola: "green",
    },
    {
      tipo: "Manutenção",
    ...
    },
    {
      ...
      data: "30/10/24",
      horario: "12:00-16:00",
      observacoes: "Instalar na sala de reunião.",
      corBola: "yellow",
    },
    {
      tipo: "Manutenção",
      data: "29/10/24",
      horario: "15:00-18:00",
      observacoes: "Verificar ar-condicionado.",
      corBola: "red",
    },
    {
      tipo: "Instalação",
      data: "30/10/24",
      horario: "12:00-16:00",
      observacoes: "Configurar sistemas.",
      corBola: "yellow",
    },
    {
      tipo: "Manutenção",
      data: "29/10/24",
      horario: "15:00-18:00",
      observacoes: "Manutenção de rede.",
      corBola: "red",
    },
  ];
        ...
        <div className="popup">
          <div className="popup-content">
            ...
            <div className="popup-buttons">
              <button className="alterar-btn" onClick={openEditPopup}>
                Alterar
              </button>
              <button className="confirmar-btn" onClick={handleConfirm}>
                Confirmar
              </button>
            </div>
          </div>
          ...
          <div className="popup-content">
            ...
            <form>
              ...
              <textarea
                name="observacoes"
                id="observacoes"
                value={selectedRequest.observacoes}
                onChange={handleEditChange}
              ></textarea>
            </form>
            ...
            <div className="popup-buttons">
              ...
              <button className="confirmar-btn" onClick={handleSaveEdit}>
                Salvar
              </button>
            </div>
          </div>
